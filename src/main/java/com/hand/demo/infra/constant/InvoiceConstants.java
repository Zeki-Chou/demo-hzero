...
public class InvoiceConstants {
    ...
    public static class Exception {
        public static final String INVALID_APPLY_HEADER = "exam47357.apply_header_error";// Code used to retrieve valid task types from LovAdapter
        public static final String NO_DATA_PROVIDED = "exam47357.no_data_error";
        public static final String INVALID_LINE_HEADER = "exam47357.apply_line_error";
    }
