...
/**
 * Inventory Count Header Table(OrderHeader47360)实体类
 *
 * @author
...
@Table(name = "todo_order_header_47360")
public class OrderHeader47360 extends AuditDomain {
    private static final long serialVersionUID = -97882351089638457L;
    ...
    @ApiModelProperty(value = "Buyer Ids")
