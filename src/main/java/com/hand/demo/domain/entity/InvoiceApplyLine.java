...
@Table(name = "47358_invoice_apply_line")
@ExcelSheet(en = "Invoice Apply Lines")
public class InvoiceApplyLine extends AuditDomain {
    private static final long serialVersionUID = -65146372319804725L;
