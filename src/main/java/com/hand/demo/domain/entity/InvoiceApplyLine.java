...
@Table(name = "47359_invoice_apply_line")
public class InvoiceApplyLine extends AuditDomain {
    private static final long serialVersionUID = -16085782005413820L;
    ...
    @ExcelColumn(en = "tax classification number")
    private String taxClassificationNumber;

    @ExcelColumn(en = "tax rate")
