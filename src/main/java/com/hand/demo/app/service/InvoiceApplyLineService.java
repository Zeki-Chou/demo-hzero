...
public interface InvoiceApplyLineService {
     ...
     * @return 返回值
     */
    Page<InvoiceApplyLineDTO> selectList(PageRequest pageRequest, InvoiceApplyLine invoiceApplyLines);
    ...
    void delete(List<InvoiceApplyLineDTO> invoiceApplyLines);
}
