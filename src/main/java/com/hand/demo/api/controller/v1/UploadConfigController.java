...
public class UploadConfigController extends BaseController {
    ...
    public UploadConfigController(UploadConfigRepository uploadConfigRepository, UploadConfigService uploadConfigService) {
        this.uploadConfigRepository = uploadConfigRepository;
        this.uploadConfigService = uploadConfigService;
    }

    @ApiOperation(value = "upload config list")
    ...
    @ApiOperation(value = "upload config detail")
    @Permission(level = ResourceLevel.ORGANIZATION)
    ...
    @ApiOperation(value = "save upload config")
    @Permission(level = ResourceLevel.ORGANIZATION)
    @PostMapping
    ...
    @ApiOperation(value = "remove upload config")
    @Permission(level = ResourceLevel.ORGANIZATION)
    @DeleteMapping
