...
@RequestMapping("v1/{organizationId}/tests")
public class TestController extends BaseController {
    private final FileService service;

    @Autowired
    public TestController(FileService service) {
    ...
    public ResponseEntity<String> deleteFile(@PathVariable Long organizationId, String bucketName, List<String> urls) {
    ...
    @Permission(level = ResourceLevel.ORGANIZATION)
    @GetMapping("/find")
    public ResponseEntity<List<FileDTO>> findFile(@PathVariable Long organizationId, String bucketName, List<String> attachmentUUIDSs) {
